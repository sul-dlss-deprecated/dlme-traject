...
to_field 'cho_language', extract_xml("#{record}/dc:language", NS),
         strip, translation_map('marc_languages'), default('NOT FOUND')

to_field 'cho_edm_type', extract_xml("#{record}/dc:type", NS),
         strip, translation_map('types'), default('NOT FOUND')
