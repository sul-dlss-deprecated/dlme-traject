...
to_field 'cho_contributor', extract_xml("#{record}/dc:contributor", Macros::BNF::NS), strip
...
to_field 'cho_language', extract_xml("#{record}/dc:language", Macros::BNF::NS), strip, translation_map('marc_languages')
